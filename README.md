...
This public repository is the canonical source for GitHub-supported community-health fallbacks, organization profile content, contribution guidance, public security/support policy, issue and pull-request templates, and agent-governance declarations for [`3fa-app-test`](https://github.com/3fa-app-test).

## Canonical organization links

- GitHub organization: https://github.com/3fa-app-test
- Public organization defaults: https://github.com/3fa-app-test/.github
